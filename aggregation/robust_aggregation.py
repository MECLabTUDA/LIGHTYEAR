...
from aggregation.AFA import AFA
from aggregation.CFL import CFL
from aggregation.Krum import Krum
from aggregation.RegFedAvg import RegFedAvg
...
class Aggregator(BaseFedAvg):
    ...
    def aggregate_fn(results: List[FLModel], algo: str) -> FLModel:
        ...
        aggr_helper = Aggregator._get_algo(algo)
        aggr_metrics_helper = Aggregator._get_algo(algo)
        all_metrics = True
        for _result in results:
